<x-layouts.front-user-layout title="Student Profile">
    <div class="wsus__dashboard_contant">
        ...
        <form action="{{ route('instructor.profile.update', auth()->user()->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="wsus__dashboard_profile wsus__dashboard_profile_avatar">
                <div class="img">
                    ...
                    @else
                        <img src="{{ asset('default') . '/green-man.jpg' }}" alt="profile" class="img-fluid w-100">
                    @endif
    ...
    <div class="wsus__dashboard_contant">
        ...
        <form action="{{ route('instructor.profile.update-password', auth()->user()->id) }}" method="post"
